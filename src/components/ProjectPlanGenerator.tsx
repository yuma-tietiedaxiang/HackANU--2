...
export function ProjectPlanGenerator({ onBack }: ProjectPlanGeneratorProps) {
  const [currentStep, setCurrentStep] = useState<'profile' | 'template' | 'generate' | 'edit'>('profile');
  ...
  const steps = [
    { id: 'profile', label: 'Company Profile', icon: Building, completed: profileUploaded },
    { id: 'template', label: 'Select Template', icon: FileText, completed: !!selectedTemplate },
    { id: 'generate', label: 'Generate Plan', icon: Zap, completed: !!generatedPlan },
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl">Project Plan Generator</h1>
            </div>
          </div>
                ...
                <>
                  <div className="text-center space-y-4 max-w-lg">
                    ...
                    <p className="text-gray-400 text-lg">
                      Upload your company profile to generate compliant project documentation. 
                      Include your vision, team size, sector, expertise, certifications, and achievements.
                    </p>
                  </div>
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-400">
                      Our AI is analyzing your company profile and preparing template options...
                    </p>
                  </div>
